...
public class Summary implements org.apache.thrift.TBase<Summary, Summary._Fields>, java.io.Serializable, Cloneable, Comparable<Summary> {
  ...
  private static final org.apache.thrift.protocol.TField AVATER_FIELD_DESC = new org.apache.thrift.protocol.TField("avater", org.apache.thrift.protocol.TType.STRING, (short)5);
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String avater; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.AVATER, new org.apache.thrift.meta_data.FieldMetaData("avater", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public Summary(Summary other) {
    ...
    if (other.isSetAvater()) {
      this.avater = other.avater;
    }
  }
  ...
  public Summary setAvater(@org.apache.thrift.annotation.Nullable java.lang.String avater) {
    this.avater = avater;
    return this;
  }

  public void unsetAvater() {
    this.avater = null;
  }

  /** Returns true if field avater is set (has been assigned a value) and false otherwise */
  public boolean isSetAvater() {
    return this.avater != null;
  }

  public void setAvaterIsSet(boolean value) {
    if (!value) {
      this.avater = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case AVATER:
      if (value == null) {
        ...
        setAvater((java.lang.String)value);
      }
      break;
  ...
  public boolean equals(Summary that) {
    ...
    boolean this_present_avater = true && this.isSetAvater();
    boolean that_present_avater = true && that.isSetAvater();
    if (this_present_avater || that_present_avater) {
      if (!(this_present_avater && that_present_avater))
        return false;
      if (!this.avater.equals(that.avater))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetAvater()) ? 131071 : 524287);
    if (isSetAvater())
      hashCode = hashCode * 8191 + avater.hashCode();
  ...
  public int compareTo(Summary other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetAvater(), other.isSetAvater());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAvater()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.avater, other.avater);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (avater == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'avater' was not present! Struct: " + toString());
    }
  ...
  private static class SummaryStandardScheme extends org.apache.thrift.scheme.StandardScheme<Summary> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, Summary struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 5: // AVATER
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.avater = iprot.readString();
              struct.setAvaterIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Summary struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      if (struct.avater != null) {
        oprot.writeFieldBegin(AVATER_FIELD_DESC);
        oprot.writeString(struct.avater);
        oprot.writeFieldEnd();
      }
