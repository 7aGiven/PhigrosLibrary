...
console.log(gameRecord[0])
console.log(gameRecord[0]["levels"])
console.log(gameRecord[0]["levels"][0])
//for (let i = 0; i < gameRecord.length; i++) console.log(gameRecord[i])
/*
const gameKey = save["gameKey"]
const keys = gameKey["keys"]
